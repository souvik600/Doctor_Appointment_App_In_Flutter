...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: heartCategoryList(),
    );
  }
}

class heartCategoryList extends StatefulWidget {
  @override
  _heartCategoryListState createState() => _heartCategoryListState();
}

class _heartCategoryListState extends State<heartCategoryList> {
  final List<HeartCategory> allCategories = [
    HeartCategory(
      name: 'Orthodontics',
  ...
  List<HeartCategory> filteredCategories = [];
